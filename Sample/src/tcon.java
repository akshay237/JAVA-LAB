		...
		try {
            ...
            if (conn != null) {
            	...
            	if(tshirtAccessories!=null && tshirtTagLine!=null && tshirtOption!=null && tcolor!=null){
            		...
            		qu="insert into Tshirts values("+10+",'"+tshirtAccessories+"','"+tshirtTagLine+"','"+tcolor+"','"+tshirtOption+"');";
        		...
        		while(rs.next()){
        		out.println("<tr>");
            		out.print("<td>"+(Integer.parseInt(rs.getString("0rderNo")))+"</td>");
